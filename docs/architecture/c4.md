...
As rotas não contêm tradução HTTP nem lógica de aplicação, e routes/controllers
não importam infraestrutura diretamente; esses limites são verificados por
